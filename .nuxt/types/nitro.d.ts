...
declare module 'nitropack' {
  ...
  interface InternalApi {
    '/api/signoutapi/signout': Awaited<ReturnType<typeof import('../../server/api/signoutapi/signout').default>>
    '/api/data/data': Awaited<ReturnType<typeof import('../../server/api/data/data').default>>
    '/api/CreateUser_Api/Update_User': Awaited<ReturnType<typeof import('../../server/api/CreateUser_Api/Update_User.put').default>>
    '/api/CreateUser_Api/GetUser': Awaited<ReturnType<typeof import('../../server/api/CreateUser_Api/GetUser.post').default>>
    '/api/CreateUser_Api/Delete_User': Awaited<ReturnType<typeof import('../../server/api/CreateUser_Api/Delete_User.delete').default>>
    '/api/CreateUser_Api/Create_User': Awaited<ReturnType<typeof import('../../server/api/CreateUser_Api/Create_User.post').default>>
    '/api/auth/testToken': Awaited<ReturnType<typeof import('../../server/api/auth/testToken').default>>
    '/api/auth/signup': Awaited<ReturnType<typeof import('../../server/api/auth/signup.post').default>>
    '/api/auth/signin': Awaited<ReturnType<typeof import('../../server/api/auth/signin').default>>
    '/api/auth/jwt.service': Awaited<ReturnType<typeof import('../../server/api/auth/jwt.service').default>>
    '/api/auth/express': Awaited<ReturnType<typeof import('../../server/api/auth/express').default>>
    '/api/Admin_Api/Create_Admin': Awaited<ReturnType<typeof import('../../server/api/Admin_Api/Create_Admin.post').default>>
...
declare global {
  ...
  const cachedEventHandler: typeof import('D:/YMS/node_modules/nitropack/dist/runtime')['cachedEventHandler']
  const cachedFunction: typeof import('D:/YMS/node_modules/nitropack/dist/runtime')['cachedFunction']
  ...
  const defineCachedEventHandler: typeof import('D:/YMS/node_modules/nitropack/dist/runtime')['defineCachedEventHandler']
  const defineCachedFunction: typeof import('D:/YMS/node_modules/nitropack/dist/runtime')['defineCachedFunction']
  const defineEventHandler: typeof import('h3')['defineEventHandler']
  const defineLazyEventHandler: typeof import('h3')['defineLazyEventHandler']
  const defineNitroPlugin: typeof import('D:/YMS/node_modules/nitropack/dist/runtime')['defineNitroPlugin']
  ...
  const defineRenderHandler: typeof import('D:/YMS/node_modules/nitropack/dist/runtime')['defineRenderHandler']
  ...
  const getRouteRules: typeof import('D:/YMS/node_modules/nitropack/dist/runtime')['getRouteRules']
  ...
  const nitroPlugin: typeof import('D:/YMS/node_modules/nitropack/dist/runtime')['nitroPlugin']
  ...
  const useNitroApp: typeof import('D:/YMS/node_modules/nitropack/dist/runtime')['useNitroApp']
  const useRuntimeConfig: typeof import('D:/YMS/node_modules/nitropack/dist/runtime')['useRuntimeConfig']
  const useSession: typeof import('h3')['useSession']
  const useStorage: typeof import('D:/YMS/node_modules/nitropack/dist/runtime')['useStorage']
